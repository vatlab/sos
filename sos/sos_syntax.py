...
SOS_OUTPUT_OPTIONS = []
SOS_DEPENDS_OPTIONS = []
SOS_RUNTIME_OPTIONS = ['workdir', 'concurrent', 'active', 'walltime', 'nodes', 'ppn', 'cores', 'mem', 'shared',
    'env', 'prepend_path', 'queue', 'to_host', 'from_host', 'preserved_vars', 'name', 'trunk_size', 'trunk_workers']
...
SOS_SECTION_OPTIONS = ['skip', 'sigil', 'provides', 'shared', 'workdir', 'local', 'remote']
