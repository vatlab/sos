...
class BaseTaskExecutor(object):
    ...
    def execute(self, task_id):
        ...
        try:
            ...
            res = self._execute_task(task_id, self.monitor_interval)
    ...
    def collect_task_result(self, task_id, sos_dict, skipped=False, signature=None):
        shared = {}
    ...
    def _execute_sub_tasks(self, task_id, params, sig_content, master_runtime):
    ...
    def _execute_task(self, task_id, monitor_interval=None, master_runtime={}):
        ...
        if hasattr(params, 'task_stack'):
            return self._execute_sub_tasks(task_id, params, sig_content, master_runtime)
        ...
        if sig and self._validate_task_signature(sig, sig_content.get(task_id, {}),
                                            task_id, subtask):
            #env.logger.info(f'{task_id} ``skipped``')
            return self.collect_task_result(
        ...
        return self.collect_task_result(task_id, sos_dict, signature=sig)
