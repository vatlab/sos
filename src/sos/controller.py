                        ...
                        if msg is None:
                            ...
                            if env.verbosity == 1:
                                if msg[1] == 'done':
                                    ...
                                    sys.stderr.write(f'\b {completed}{", " if completed and ignored else ""}{ignored}\n')
                                    sys.stderr.flush()
                                else:
                                    # self._completed[msg[1]] += 1
                                    if 'ignored' in msg[1]:
                                        sys.stderr.write(f'\b\033[90m=\033[0m\033[92m>\033[0m')
                                        self._ignored[msg[2]] += 1
                                    else:
                                        sys.stderr.write(f'\b\033[92m=>\033[0m')
