...
def test_setup(test_workflow):
    assertExists(["ut_d1", "ut_d2", "ut_d2/ut_d3", "ut_f1", "ut_d1/ut_f2", "ut_d2/ut_d3/ut_f3"])
    assertExists(["t_f1", "t_d1/t_f2", "t_d2/t_d3/t_f3", "t_d2/t_d3", "t_d2"])
...
def test_remove_all_untracked(test_workflow):
    ...
    assertExists(["t_d1/t_f2", "t_d2/t_d3/t_f3", "t_d2/t_d3", "t_d2", "t_d1", "t_f1"])
...
def test_remove_specific_untracked(test_workflow):
    ...
    assertExists(["t_d1/t_f2", "t_d2/t_d3/t_f3", "t_d2/t_d3", "t_d2", "t_d1", "t_f1"])
    assertExists(["ut_d1", "ut_d2", "ut_d2/ut_d3", "ut_d2/ut_d3/ut_f3"])
...
def test_remove_by_age(test_workflow):
    ...
    assertExists(["ut_f1", "t_f1", "t_d2/t_d3", "t_d2", "t_d1", "ut_d1", "ut_d2", "ut_d2/ut_d3"])
